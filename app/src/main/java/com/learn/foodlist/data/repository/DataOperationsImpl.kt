...
import com.learn.foodlist.util.Constants.PREFERENCES_KEY
import com.learn.foodlist.util.Constants.PREFERENCES_NAME
...
class DataOperationsImpl @Inject constructor(@ApplicationContext context: Context): DataStoreOperations {
